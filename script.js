document.addEventListener('DOMContentLoaded', () => {
    ...
    const supplierBusinessNumberEl = document.getElementById('supplier-business-number'); // Added
    ...
    const modalBusinessNumber = document.getElementById('modal-business-number'); // Added
    ...
    let state = {
        ...
        supplierInfo: { company: '', businessNumber: '', contactPerson: '', phone: '' },
        sealImage: null,
        savedProducts: []
    };
    ...
    const renderSupplierInfo = () => {
        ...
        supplierBusinessNumberEl.textContent = state.supplierInfo.businessNumber; // Added
    ...
    supplierSettingsBtn.addEventListener('click', () => {
        ...
        modalBusinessNumber.value = state.supplierInfo.businessNumber; // Added
    ...
    saveSupplierBtn.addEventListener('click', () => {
        state.supplierInfo = {
            ...
            businessNumber: modalBusinessNumber.value, // Added
